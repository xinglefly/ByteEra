...
public class CircleView extends ImageView{
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        ...
        mBorderThickness = a.getDimensionPixelSize(R.styleable.CircleView_border_thickness, 0);
        mBorderOutsideColor = a.getColor(R.styleable.CircleView_border_outside_color, defaultColor);
        mBorderInsideColor = a.getColor(R.styleable.CircleView_border_inside_color, defaultColor);
    }
