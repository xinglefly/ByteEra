...
public class HeadViewMain extends FrameLayout implements View.OnClickListener {
    ...
    private void initView(AttributeSet attrs) {
        ...
        int backgoundColor = attributes.getColor(R.styleable.HeadViewMain_background, getResources().getColor(R.color.head_view_bg));
    ...
    public void isSHowRightImg(boolean isClick) {
        if (isClick) {
