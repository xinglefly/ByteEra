...
//            Emojicon.fromCodePoint(0x1f4ad),
    ...
    public static final Emojicon[] CUSTOMDATA = new Emojicon[]{
            Emojicon.fromChars("[微笑]"),Emojicon.fromChars("[色]"),
            Emojicon.fromChars("[吃惊]"),Emojicon.fromChars("[得意]"),
            Emojicon.fromChars("[流泪]"),Emojicon.fromChars("[害羞]"),Emojicon.fromChars("[闭嘴]"),
            Emojicon.fromChars("[睡觉]"),Emojicon.fromChars("[发怒]"),
            Emojicon.fromChars("[呲牙]"),Emojicon.fromChars("[偷笑]"),Emojicon.fromChars("[可爱]"),
            Emojicon.fromChars("[疑惑]"),Emojicon.fromChars("[憨笑]"),
            Emojicon.fromChars("[屌]"),Emojicon.fromChars("[奋斗]"),Emojicon.fromChars("[嘘]"),Emojicon.fromChars("[砸头]"),
            Emojicon.fromChars("[再见]"),Emojicon.fromChars("[鼓掌]"),
            Emojicon.fromChars("[捂耳朵]"),Emojicon.fromChars("[扮鬼脸]"),Emojicon.fromChars("[委屈]"),
            Emojicon.fromChars("[傲慢]"),Emojicon.fromChars("[赞]"),Emojicon.fromChars("[惊吓]"),Emojicon.fromChars("[心碎]")
    };
