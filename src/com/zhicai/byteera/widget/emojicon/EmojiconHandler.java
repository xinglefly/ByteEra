...
public final class EmojiconHandler {
    ...
    private static final HashMap<String, Integer> customEmojiMap = new HashMap<String, Integer>(0);
    private static int emojiMinLength = 10;
    private static int emojiMaxLength = 0;
//    static {
//        // People
...
//        emojiMinLength = 3;
//        emojiMaxLength = 5;
//        customEmojiMap.put("[微笑]", R.drawable.emoji_001);
//        customEmojiMap.put("[色]", R.drawable.emoji_002);
//        customEmojiMap.put("[吃惊]", R.drawable.emoji_003);
//        customEmojiMap.put("[得意]", R.drawable.emoji_004);
//        customEmojiMap.put("[流泪]", R.drawable.emoji_005);
//        customEmojiMap.put("[害羞]", R.drawable.emoji_006);
//        customEmojiMap.put("[闭嘴]", R.drawable.emoji_007);
//        customEmojiMap.put("[睡觉]", R.drawable.emoji_008);
//        customEmojiMap.put("[发怒]", R.drawable.emoji_009);
//        customEmojiMap.put("[呲牙]", R.drawable.emoji_010);
//        customEmojiMap.put("[偷笑]", R.drawable.emoji_011);
//        customEmojiMap.put("[可爱]", R.drawable.emoji_012);
//        customEmojiMap.put("[疑惑]", R.drawable.emoji_013);
//        customEmojiMap.put("[憨笑]", R.drawable.emoji_014);
//        customEmojiMap.put("[屌]", R.drawable.emoji_015);
//        customEmojiMap.put("[奋斗]", R.drawable.emoji_016);
//        customEmojiMap.put("[嘘]", R.drawable.emoji_017);
//        customEmojiMap.put("[砸头]", R.drawable.emoji_018);
//        customEmojiMap.put("[再见]", R.drawable.emoji_019);
//        customEmojiMap.put("[鼓掌]", R.drawable.emoji_020);
//        customEmojiMap.put("[捂耳朵]", R.drawable.emoji_021);
//        customEmojiMap.put("[扮鬼脸]", R.drawable.emoji_022);
//        customEmojiMap.put("[委屈]", R.drawable.emoji_023);
//        customEmojiMap.put("[傲慢]", R.drawable.emoji_024);
//        customEmojiMap.put("[赞]", R.drawable.emoji_025);
//        customEmojiMap.put("[惊吓]", R.drawable.emoji_026);
//        customEmojiMap.put("[心碎]", R.drawable.emoji_027);
//    }
    ...
    public static void addEmojis(Context context, Spannable text, int emojiSize, int index, int length, boolean useSystemDefault) {
        ...
        for (int i = index; i < textLengthToProcess; i += skip) {
            ...
            if (icon == 0){
                for (int j=emojiMinLength;j<=emojiMaxLength;j++){
                    if (i + j <= textLengthToProcess){
                        String subString = text.toString().substring(i, i+j);
                        if (!TextUtils.isEmpty(subString)){
                            Integer value = customEmojiMap.get(subString);
                            if(value != null){
                                icon = value;
                                skip = j;
                                break;
