...
public class HasHeadLoadMoreListViewNoMeasure extends ListView implements AbsListView.OnScrollListener {
    ...
    public HasHeadLoadMoreListViewNoMeasure(Context context, AttributeSet att) {
        super(context, att);
        initView();
    }
