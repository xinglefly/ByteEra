...
public class ColoredRatingBar extends View {
    ...
    public interface OnRatingBarChangeListener {
         ...
         * @param fromUser  True if the rating change was initiated by a user's touch
    ...
    public ColoredRatingBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ColoredRatingBar, defStyle, 0);
        ...
        final int type = a.getInt(R.styleable.ColoredRatingBar_ratingtype, 0);
        a.recycle();
...
//		if (mType == SMALL) {
//			drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.drawable.star_red_small), BitmapFactory.decodeResource(res, R.drawable.star_orange_small),
//					BitmapFactory.decodeResource(res, R.drawable.star_green_small)};
//			progressBackground = BitmapFactory.decodeResource(res, R.drawable.star_black_small);
//		} else {
//			drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.drawable.star_red), BitmapFactory.decodeResource(res, R.drawable.star_orange),
//					BitmapFactory.decodeResource(res, R.drawable.star_green)};
//			progressBackground = BitmapFactory.decodeResource(res, R.drawable.star_black);
//		}
        if (mType == SMALL) {
            drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.drawable.star_yellow), BitmapFactory.decodeResource(res, R.drawable.star_yellow),
                    BitmapFactory.decodeResource(res, R.drawable.star_yellow)};
            progressBackground = BitmapFactory.decodeResource(res, R.drawable.star_grey);
        } else {
            drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.drawable.star_yellow), BitmapFactory.decodeResource(res, R.drawable.star_yellow),
                    BitmapFactory.decodeResource(res, R.drawable.star_yellow)};
            progressBackground = BitmapFactory.decodeResource(res, R.drawable.star_grey);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                float slidePosition = getRelativePosition(event.getX());
