...
public class ViewPagerIndicator extends LinearLayout {
    ...
    /** 设置tab的标题内容 可选，可以自己在布局文件中写死 @param datas */
    ...
    /** 指示器跟随手指滚动，以及容器滚动 @param position @param offset */
    public void scroll(int position, float offset) {
         ...
         */
        // 不断改变偏移量，invalidate
        mTranslationX = (getWidth()-UIUtils.dip2px(getContext(),20)) / mTabVisibleCount * (position + offset);
    ...
    public int getScreenWidth() {
        ...
        return outMetrics.widthPixels - UIUtils.dip2px(getContext(), 80);
    }
