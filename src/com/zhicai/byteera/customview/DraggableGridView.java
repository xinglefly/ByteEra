...
public class DraggableGridView extends RelativeLayout implements View.OnTouchListener, View.OnClickListener, View.OnLongClickListener {
	//layout vars
    ...
    //anim vars
    public static int animT = 120;
    protected ArrayList<Integer> newPositions = new ArrayList<Integer>();
    //listeners
    protected OnRearrangeListen onRearrangeListener;
    ...
    protected int getTargetFromCoor(int x, int y)
    {
        ...
        int leftPos = getIndexFromCoor(x - (childSize / 1), y);
        int rightPos = getIndexFromCoor(x + (childSize /2), y);
    ...
    protected void animateDragged()
    {
		...
		ScaleAnimation scale = new ScaleAnimation(.667f, 0.7f, .667f, 0.7f, childSize / 4, childSize / 4  );
    ...
    //OTHER METHODS
    public void setOnRearrangeListener(OnRearrangeListen l)
    {
