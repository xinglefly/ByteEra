...
public class OrganizationDynamicItem extends FrameLayout implements OrganizationDynamicItemIV {
    ...
    public void refreshView(final DynamicEntity entity, final int position, OrganizationHomePre organizationHomepre) {
        boolean hasZan = false;
        this.organizationHomePre = organizationHomepre;
        this.organizationHomePre.addOrganizationDynamicItemIV(position, this);
