...
public class MyAttentionAdapter extends BaseAdapter {
    ...
    private MyAttentionFragmentPre myAttentionFragmentPre;

    public MyAttentionAdapter(Context context, MyAttentionFragmentPre myAttentionFragmentPre) {
        this.mContext = context;
        this.myAttentionFragmentPre = myAttentionFragmentPre;
    }
