...
import com.zhicai.byteera.task.LoadLocalBigImgTask;
...
public class ShowBigImage extends BaseActivity {
	...
	private int default_res = R.drawable.consult_default;
	...
	protected void loadViewLayout() {
		...
		default_res = getIntent().getIntExtra("default_image", R.drawable.consult_default);
