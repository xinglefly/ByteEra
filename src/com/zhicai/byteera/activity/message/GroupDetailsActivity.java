...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
	...
	@Bind(R.id.gridview) ExpandGridView userGridview;
	private String groupId;
	@Bind(R.id.progressBar) ProgressBar loadingPB;
	@Bind(R.id.btn_exit_grp) Button exitBtn;
	@Bind(R.id.btn_exitdel_grp) Button deleteBtn;
	...
	@Bind(R.id.rl_switch_block_groupmsg) RelativeLayout rl_switch_block_groupmsg;
	/**
	 * 屏蔽群消息imageView
	 */
	@Bind(R.id.iv_switch_block_groupmsg) ImageView iv_switch_block_groupmsg;
	/**
	 * 关闭屏蔽群消息imageview
	 */
	@Bind(R.id.iv_switch_unblock_groupmsg) ImageView iv_switch_unblock_groupmsg;

	public static GroupDetailsActivity instance;

	String st = "";
	// 清空所有聊天记录
	@Bind(R.id.clear_all_history) RelativeLayout clearAllHistory;
	@Bind(R.id.rl_blacklist) RelativeLayout blacklistLayout;
	@Bind(R.id.rl_change_group_name) RelativeLayout changeGroupNameLayout;

	@Bind(R.id.iv_home) ImageView homeImageView;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			...
			case REQUEST_CODE_EDIT_GROUPNAME: // 修改群名称
				final String returnData = data.getStringExtra("edittext");
	...
	public void onClick(View v) {
		...
		case R.id.rl_change_group_name:
			startActivityForResult(
					new Intent(this, AlertDialogActivity.class).putExtra("msg", "群聊名称")
							.putExtra("edit_text", group.getGroupName()).putExtra("editTextShow", true),
	...
	private class GridAdapter extends ArrayAdapter<String> {
		...
		public View getView(final int position, View convertView, final ViewGroup parent) {
			...
			if (position == getCount() - 1) {
				...
				holder.imageView.setImageResource(R.drawable.head_liang);
					...
					public void onClick(View v) {
						if (isInDeleteMode) {
							...
							if (EMChatManager.getInstance().getCurrentUser().equals(username)) {
								ActivityUtil.startActivity(GroupDetailsActivity.this,new Intent(GroupDetailsActivity.this, AlertDialogActivity.class)
										.putExtra("msg", st12));
								return;
							}
