...
public class KnowWealthDetailCommentActivity$$ViewBinder<T extends com.zhicai.byteera.activity.knowwealth.view.KnowWealthDetailCommentActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131427625, "method 'click'");
    ...
    view = finder.findRequiredView(source, 2131427933, "method 'click'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
