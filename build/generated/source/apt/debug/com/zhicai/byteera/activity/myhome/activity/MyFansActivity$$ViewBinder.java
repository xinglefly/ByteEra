...
public class MyFansActivity$$ViewBinder<T extends com.zhicai.byteera.activity.myhome.activity.MyFansActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131427573, "field 'mListView' and method 'itemClickListener'");
